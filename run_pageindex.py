...
if __name__ == "__main__":
    ...
    parser.add_argument('--md_path', type=str, default='md_path/物业管理服务.md', help='Path to the Markdown file')

    parser.add_argument('--model', type=str, default='Qwen3.5-27B', help='Model to use')
